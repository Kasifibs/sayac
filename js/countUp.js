...
CountUp.prototype.update=function(id){
    ...
    countainer.innerHTML ="<strong>" + this.years + "</strong> <small>Yil</small> <strong>" +
        this.months + "</strong> <small>Ay</small><strong> " + this.days + 
        "</strong> <small>Gun</small> <strong>" + this.hours + "</strong> <small>Saat</small> <strong>" + 
        this.minutes + "</strong> <small>Dakika</small> <strong>" + this.seconds +
        "</strong> <small>Saniye</small> Once";
    var self=this;
